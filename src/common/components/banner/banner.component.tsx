    ...
    return (
        <div className="bg-conduit-300 shadow-banner text-white p-8 mb-8">
            <Container>
                ...
                <motion.p className="text-xl text-center lg:text-2xl font-light text-white" initial={pVariants.hidden2} animate={pVariants.visible} transition={{ duration: 1 }} variants={pVariants}>Are you thinking about something? -
